...
try:
    ...
    s = 3.14 * r ** 2
    p= 2 * 3.14 * r
    print(f"Ringi pindala on {s:0.2f} ja ümbermõõt {p:.2f}")
    turtle.circle(r)
except:
...
try:
    ...
    kingitusi_kokku = kingitused // maht #taisarvuline jagamine
...
# Aed on ristküliku kujuline. 2(a+b) = P
